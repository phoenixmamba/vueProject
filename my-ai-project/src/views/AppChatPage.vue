  ...
  <div id="appChatPage">
    ...
    <div class="header-bar">
      <div class="header-left">
        ...
        <!-- <el-tag v-if="appInfo?.codeGenType" type="primary" class="code-gen-type-tag">
      ...
      <div class="chat-section">
        ...
        <div class="messages-container" ref="messagesContainer">
          ...
          <div v-if="hasMoreHistory" class="load-more-container">
            <el-button link @click="loadMoreHistory" :loading="loadingHistory" size="small">
              加载更多历史消息
            </el-button>
          </div>
          <div v-for="(message, index) in messages" :key="index" class="message-item">
            <div v-if="message.type === 'user'" class="user-message">
              ...
              <!-- <div class="message-avatar">
                <el-avatar :src="loginUserStore.loginUser.userAvatar" />
              </div> -->
            </div>
      ...
      <div class="preview-section">
        ...
        <div class="preview-content">
          ...
          <div v-else-if="isGenerating" class="preview-loading">
            <el-icon class="is-loading" style="font-size: 32px"><Position /></el-icon>
            <p>正在生成网站...</p>
          </div>
          <iframe
              v-else
